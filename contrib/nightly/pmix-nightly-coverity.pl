...
my $coverity_project = "open-mpi%2Fgds";
...
if ($dry_run_arg) {
    ...
    safe_system(0, "curl --form token=$coverity_token_arg " .
                ...
                "--form file=\@$gds_ver-analyzed.tar.bz2 " .
                "--form version=$gds_ver " .
