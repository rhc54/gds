...
# GDS SEARCH_LIBS_CORE(func, list-of-libraries,
...
# GDS_SEARCH_LIBS_COMPONENT.  The reason why is because this macro
# calls GDS_WRAPPER_FLAGS_ADD -- see big comment in
# gds_setup_wrappers.m4 for an explanation of why this is bad).
AC_DEFUN([GDS_SEARCH_LIBS_CORE],[
    AC_SEARCH_LIBS([$1], [$2],
        [gds_have_$1=1
         $3],
        [gds_have_$1=0
    ...
    AC_DEFINE_UNQUOTED([GDS_HAVE_]m4_toupper($1), [$gds_have_$1],
