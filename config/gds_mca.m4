...
# with GDS's autogen.pl, requiring it's specially formatted lists
...
######################################################################
AC_DEFUN([GDS_MCA],[
    dnl for GDS_CONFIGURE_USER env variable
    AC_REQUIRE([GDS_CONFIGURE_SETUP])
...
*** list of type-component pairs.  Invalid input detected.])
    ...
    # now configure the GDS project.  Most
    ...
    gds_show_subtitle "Configuring MCA"

    AC_MSG_CHECKING([for frameworks])
    AC_MSG_RESULT([mca_gds_framework_list])
    ...
    m4_ifdef([mca_gds_framework_list], [],
             [m4_fatal([Could not find mca_gds_framework_list - please rerun autogen.pl])])
    ...
    m4_foreach(mca_framework, [mca_gds_framework_list],
               [m4_ifval(mca_framework,
                         [dnl common has to go up front
                          m4_if(mca_framework, [common],
                                [MCA_gds_FRAMEWORKS="mca_framework $MCA_gds_FRAMEWORKS"
                                 MCA_gds_FRAMEWORKS_SUBDIRS="[mca/]mca_framework $MCA_gds_FRAMEWORKS_SUBDIRS"
                                 MCA_gds_FRAMEWORK_COMPONENT_ALL_SUBDIRS="[\$(MCA_gds_]mca_framework[_ALL_SUBDIRS)] $MCA_gds_FRAMEWORK_COMPONENT_ALL_SUBDIRS"
                                 MCA_gds_FRAMEWORK_COMPONENT_DSO_SUBDIRS="[\$(MCA_gds_]mca_framework[_DSO_SUBDIRS)] $MCA_gds_FRAMEWORK_COMPONENT_DSO_SUBDIRS"
                                 MCA_gds_FRAMEWORK_COMPONENT_STATIC_SUBDIRS="[\$(MCA_gds_]mca_framework[_STATIC_SUBDIRS)] $MCA_gds_FRAMEWORK_COMPONENT_STATIC_SUBDIRS"
                                ], [
                                 MCA_gds_FRAMEWORKS="$MCA_gds_FRAMEWORKS mca_framework"
                                 MCA_gds_FRAMEWORKS_SUBDIRS="$MCA_gds_FRAMEWORKS_SUBDIRS [mca/]mca_framework"
                                 MCA_gds_FRAMEWORK_COMPONENT_ALL_SUBDIRS="$MCA_gds_FRAMEWORK_COMPONENT_ALL_SUBDIRS [\$(MCA_gds_]mca_framework[_ALL_SUBDIRS)]"
                                 MCA_gds_FRAMEWORK_COMPONENT_DSO_SUBDIRS="$MCA_gds_FRAMEWORK_COMPONENT_DSO_SUBDIRS [\$(MCA_]gds[_]mca_framework[_DSO_SUBDIRS)]"
                                 MCA_gds_FRAMEWORK_COMPONENT_STATIC_SUBDIRS="$MCA_gds_FRAMEWORK_COMPONENT_STATIC_SUBDIRS [\$(MCA_gds_]mca_framework[_STATIC_SUBDIRS)]"
                                 MCA_gds_FRAMEWORK_LIBS="$MCA_gds_FRAMEWORK_LIBS [mca/]mca_framework[/libmca_]mca_framework[.la]"])
                          MCA_gds_FRAMEWORK_LIBS="$MCA_gds_FRAMEWORK_LIBS [\$(MCA_gds_]mca_framework[_STATIC_LTLIBS)]"
                          m4_ifdef([MCA_gds_]mca_framework[_CONFIG],
                                   [MCA_gds_]mca_framework[_CONFIG](mca_framework),
    ...
    gds_mca_wrapper_extra_cppflags="$mca_wrapper_extra_cppflags"
    gds_mca_wrapper_extra_ldflags="$mca_wrapper_extra_ldflags"
    gds_mca_wrapper_extra_libs="$mca_wrapper_extra_libs"

    AC_SUBST(MCA_gds_FRAMEWORKS)
    AC_SUBST(MCA_gds_FRAMEWORKS_SUBDIRS)
    AC_SUBST(MCA_gds_FRAMEWORK_COMPONENT_ALL_SUBDIRS)
    AC_SUBST(MCA_gds_FRAMEWORK_COMPONENT_DSO_SUBDIRS)
    AC_SUBST(MCA_gds_FRAMEWORK_COMPONENT_STATIC_SUBDIRS)
    AC_SUBST(MCA_gds_FRAMEWORK_LIBS)
...
AC_DEFUN([MCA_ORDER_COMPONENT_LIST], [
    m4_foreach(mca_component, [mca_gds_$1_m4_config_component_list],
               [m4_ifval(mca_component,
                    [m4_ifdef([MCA_gds_]$1[_]mca_component[_PRIORITY], [],
                         [m4_fatal([MCA_gds_$1_]mca_component[_PRIORITY not found, but required.])])])])
    m4_define([component_list],
              [esyscmd([config/gds_mca_priority_sort.pl] m4_foreach([mca_component], [mca_gds_$1_m4_config_component_list],
                        [m4_ifval(mca_component, [mca_component ]GDS_EVAL_ARG([MCA_gds_]$1[_]mca_component[_PRIORITY ]))]))])
])
...
AC_DEFUN([MCA_CHECK_IGNORED_PRIORITY], [
    m4_foreach(mca_component, [mca_gds_$1_m4_config_component_list],
               [m4_ifval(mca_component,
                    [m4_ifdef([MCA_gds_]$1[_]mca_component[_PRIORITY],
                         [m4_warn([unsupported], [MCA_gds_]$1[_]mca_component[_PRIORITY found, but ignored.])])])])
])
...
AC_DEFUN([MCA_CONFIGURE_FRAMEWORK],[
    gds_show_subsubtitle "Configuring MCA framework $1"

    m4_ifdef([mca_gds_$1_no_config_component_list], [],
             [m4_fatal([Could not find mca_gds_$1_no_config_component_list - please rerun autogen.pl])])
    m4_ifdef([mca_gds_$1_m4_config_component_list], [],
             [m4_fatal([Could not find mca_gds_$1_m4_config_component_list - please rerun autogen.pl])])
    ...
    m4_foreach(mca_component, [mca_gds_$1_no_config_component_list],
               [m4_ifval(mca_component,
    ...
    m4_if(GDS_EVAL_ARG([MCA_gds_$1_CONFIGURE_MODE]), [STOP_AT_FIRST], [MCA_ORDER_COMPONENT_LIST($1)],
          [m4_if(GDS_EVAL_ARG([MCA_gds_$1_CONFIGURE_MODE]), [STOP_AT_FIRST_PRIORITY], [MCA_ORDER_COMPONENT_LIST($1)],
                [m4_if(GDS_EVAL_ARG([MCA_gds_$1_CONFIGURE_MODE]), [PRIORITY], [MCA_ORDER_COMPONENT_LIST($1)],
                       [m4_define([component_list], [mca_gds_$1_m4_config_component_list])])])])
    ...
    m4_foreach(mca_component, [component_list],
               [m4_ifval(mca_component,
                  [m4_if(GDS_EVAL_ARG([MCA_gds_$1_CONFIGURE_MODE]), [STOP_AT_FIRST_PRIORITY],
                         [AS_IF([test $best_mca_component_priority -gt MCA_gds_$1_]mca_component[_PRIORITY], [components_looking_for_succeed=0])])
                   ...
                   m4_if(GDS_EVAL_ARG([MCA_gds_$1_CONFIGURE_MODE]), [STOP_AT_FIRST_PRIORITY],
                         [AS_IF([test $components_last_result -eq 1], [best_mca_component_priority=]GDS_EVAL_ARG([MCA_gds_$1_]mca_component[_PRIORITY]))])
                   ])])

    # configure components that provide their own configure script.
    # It would be really hard to run these for "find first that
    # works", so we don't :)
    m4_if(GDS_EVAL_ARG([MCA_gds_]$1[_CONFIGURE_MODE]), [STOP_AT_FIRST], [],
        [m4_if(GDS_EVAL_ARG([MCA_gds_]$1[_CONFIGURE_MODE]), [STOP_AT_FIRST_PRIORITY], [],
             [m4_if(GDS_EVAL_ARG([MCA_gds_]$1[_CONFIGURE_MODE]), [PRIORITY], [],
    ...
    MCA_gds_$1_ALL_COMPONENTS="$all_components"
    MCA_gds_$1_STATIC_COMPONENTS="$static_components"
    MCA_gds_$1_DSO_COMPONENTS="$dso_components"
    MCA_gds_$1_STATIC_LTLIBS="$static_ltlibs"

    AC_SUBST(MCA_gds_$1_ALL_COMPONENTS)
    AC_SUBST(MCA_gds_$1_STATIC_COMPONENTS)
    AC_SUBST(MCA_gds_$1_DSO_COMPONENTS)
    AC_SUBST(MCA_gds_$1_STATIC_LTLIBS)

    GDS_MCA_MAKE_DIR_LIST(MCA_gds_$1_ALL_SUBDIRS, $1, [$all_components])
    GDS_MCA_MAKE_DIR_LIST(MCA_gds_$1_STATIC_SUBDIRS, $1, [$static_components])
    GDS_MCA_MAKE_DIR_LIST(MCA_gds_$1_DSO_SUBDIRS, $1, [$dso_components])
...
const gds_mca_base_component_t *mca_$1_base_static_components[[]] = {
`cat $outfile.struct`
  NULL
};
...
AC_DEFUN([MCA_CONFIGURE_NO_CONFIG_COMPONENT],[
    gds_show_subsubsubtitle "MCA component $1:$2 (no configuration)"

    gds_show_verbose "GDS_MCA_NO_CONFIG_COMPONENT: before, should_build=$7"
    MCA_COMPONENT_BUILD_CHECK($1, $2,
                              [should_build=$7], [should_build=0])
    MCA_COMPONENT_COMPILE_MODE($1, $2, compile_mode)
    gds_show_verbose "GDS_MCA_NO_CONFIG_COMPONENT: after, should_build=$should_build"
    ...
    if test "$compile_mode" = "dso" ; then
        BUILD_gds_$1_$2_DSO=1
    else
        BUILD_gds_$1_$2_DSO=0
    fi
    AM_CONDITIONAL(MCA_BUILD_gds_$1_$2_DSO, test "$BUILD_gds_$1_$2_DSO" = "1")
...
AC_DEFUN([MCA_CONFIGURE_M4_CONFIG_COMPONENT],[
    m4_ifdef([MCA_gds_$1_$2_PRIORITY],
        [gds_show_subsubsubtitle "MCA component $1:$2 (m4 configuration macro, priority MCA_gds_$1_$2_PRIORITY)"],
        [gds_show_subsubsubtitle "MCA component $1:$2 (m4 configuration macro)"])

    gds_show_verbose "GDS_MCA_M4_CONFIG_COMPONENT: before, should_build=$7"
    ...
    m4_ifdef([MCA_gds_$1_$2_COMPILE_MODE],
             [MCA_gds_$1_$2_COMPILE_MODE($1, $2, compile_mode)],
             [MCA_COMPONENT_COMPILE_MODE($1, $2, compile_mode)])

    # try to configure the component
    m4_ifdef([MCA_gds_$1_$2_CONFIG],
             [MCA_gds_$1_$2_CONFIG([should_build=$should_build],
                                  [should_build=0])],
             [m4_fatal([MCA_gds_$1_$2_CONFIG macro not found])])
    gds_show_verbose "GDS_MCA_M4_CONFIG_COMPONENT: after, should_build=$should_build"
    ...
    m4_ifdef([MCA_gds_$1_$2_POST_CONFIG],
             [ MCA_gds_$1_$2_POST_CONFIG($should_build)])
...
AC_DEFUN([MCA_CONFIGURE_ALL_CONFIG_COMPONENTS],[
    for component_path in $srcdir/src/mca/$1/* ; do
        ...
        if test -d $component_path && test -x $component_path/configure ; then
            gds_show_subsubsubtitle "MCA component $1:$component (need to configure)"

            gds_show_verbose "GDS_MCA_ALL_CONFIG_COMPONENTS: before, should_build=$7"
            MCA_COMPONENT_BUILD_CHECK($1, $component,
                                      [should_build=1], [should_build=0])
            MCA_COMPONENT_COMPILE_MODE($1, $component, compile_mode)
            gds_show_verbose "GDS_MCA_ALL_CONFIG_COMPONENTS: after, should_build=$should_build"

            if test "$should_build" = "1" ; then
                GDS_CONFIG_SUBDIR([src/mca/$1/$component],
                                   [$gds_subdir_args],
                                   [should_build=1], [should_build=0])
                gds_show_verbose "GDS_MCA_ALL_CONFIG_COMPONENTS: after subdir, should_build=$should_build"
            fi
...
AC_DEFUN([MCA_PROCESS_COMPONENT],[
    ...
    if test "$7" = "dso" ; then
        ...
        if test "$1" = "common"; then
            ...
            # set.
            $6="mca/$1/$2/lib${m4_translit([gds], [a-z], [A-Z])_LIB_PREFIX}mca_$1_$2.la $$6"
        else
            # Other frameworks do not have to obey the
            # $FRAMEWORK_LIB_PREFIX prefix.
            $6="mca/$1/$2/libmca_$1_$2.la $$6"
        fi
        echo "extern const gds_mca_base_component_t mca_$1_$2_component;" >> $outfile.extern
    ...
    dnl handle the headers for static components like timers in GDS, ie, have a framework level configure.m4 that
    ...
    if test -f $infile; then
        ...
        if test "$DIRECT_$1" = "$2" ; then
            if test "`$GREP DIRECT_CALL_HEADER $infile`" != "" ; then
                ...
                str="MCA_gds_$1_DIRECT_CALL_HEADER=$line"
                eval $str
            else
...
*** Aborting])
        ...
        AS_LITERAL_IF([$2],
            [m4_foreach(flags, [LDFLAGS, LIBS],
                    [AS_IF([test "$$1_$2_WRAPPER_EXTRA_]flags[" = ""],
                           [GDS_FLAGS_APPEND_UNIQ([mca_wrapper_extra_]m4_tolower(flags), [$$1_$2_]flags)],
                           [GDS_FLAGS_APPEND_UNIQ([mca_wrapper_extra_]m4_tolower(flags), [$$1_$2_WRAPPER_EXTRA_]flags)])
                        ])],
            [m4_foreach(flags, [LDFLAGS, LIBS],
                    [[str="line=\$$1_$2_WRAPPER_EXTRA_]flags["]
                      eval "$str"
                      GDS_FLAGS_APPEND_UNIQ([mca_wrapper_extra_]m4_tolower(flags), [$line])])])
    fi
    ...
    AS_LITERAL_IF([$2],
        [AS_IF([test "$$1_$2_WRAPPER_EXTRA_CPPFLAGS" != ""],
           [m4_if(GDS_EVAL_ARG([MCA_gds_$1_CONFIGURE_MODE]), [STOP_AT_FIRST], [stop_at_first=1], [stop_at_first=0])
            AS_IF([test "$7" = "static" && test "$stop_at_first" = "1"],
              [AS_IF([test "$with_devel_headers" = "yes"],
                     [GDS_FLAGS_APPEND_UNIQ([mca_wrapper_extra_cppflags], [$$1_$2_WRAPPER_EXTRA_CPPFLAGS])])],
...
AC_DEFUN([MCA_COMPONENT_BUILD_CHECK],[
    ...
    # - there is no gds_ignore file
    # - there is an gds_ignore, but there is an empty gds_unignore
    # - there is an gds_ignore, but username is in gds_unignore
    if test -d $component_path ; then
        ...
        want_component=1
        if test -f $component_path/.gds_ignore ; then
            # If there is an gds_ignore file, don't build
            # the component.  Note that this decision can be
            # overridden by the unignore logic below.
            want_component=0
        fi
        if test -f $component_path/.gds_unignore ; then
            # if there is an empty gds_unignore, that is
            # equivalent to having your userid in the unignore file.
            # If userid is in the file, unignore the ignore file.
            if test ! -s $component_path/.gds_unignore ; then
                want_component=1
            elif test ! -z "`$GREP $GDS_CONFIGURE_USER $component_path/.gds_unignore`" ; then
                want_component=1
            fi
        fi
...
AC_DEFUN([MCA_SETUP_DIRECT_CALL],[
    if test ! -z "$DIRECT_$1" ; then
        MCA_gds_$1_DIRECT_CALL_COMPONENT=$DIRECT_$1
        MCA_gds_$1_DIRECT_CALL=1
    else
        MCA_gds_$1_DIRECT_CALL_COMPONENT=
        MCA_gds_$1_DIRECT_CALL=0
    fi

    AC_SUBST(MCA_gds_$1_DIRECT_CALL_HEADER)
    AC_DEFINE_UNQUOTED([MCA_gds_$2_DIRECT_CALL], [$MCA_gds_$1_DIRECT_CALL],
            [Defined to 1 if GDS:$1 should use direct calls instead of components])
    AC_DEFINE_UNQUOTED([MCA_gds_$1_DIRECT_CALL_COMPONENT], [$MCA_gds_$1_DIRECT_CALL_COMPONENT],
            [name of component to use for direct calls, if MCA_gds_$1_DIRECT_CALL is 1])
    AC_DEFINE_UNQUOTED([MCA_gds_$1_DIRECT_CALL_HEADER],
                       ["[$MCA_gds_]$1[_DIRECT_CALL_HEADER]"],
                       [Header GDS:$1 includes to be direct called])
])


# GDS_MCA_MAKE_DIR_LIST(subst'ed variable, framework, shell list)
# -------------------------------------------------------------------------
AC_DEFUN([GDS_MCA_MAKE_DIR_LIST],[
    $1=
    for item in $3 ; do
       $1="$$1 mca/$2/$item"
    done
