 ...
 */
int  gds_snprintf(char *str, size_t size, const char *fmt, ...) __gds_attribute_format__(__printf__, 3, 4);
 ...
 */
int  gds_vsnprintf(char *str, size_t size, const char *fmt, va_list ap) __gds_attribute_format__(__printf__, 3, 0);
 ...
 */
int  gds_asprintf(char **ptr, const char *fmt, ...) __gds_attribute_format__(__printf__, 2, 3);
 ...
 */
int  gds_vasprintf(char **ptr, const char *fmt, va_list ap) __gds_attribute_format__(__printf__, 2, 0);
