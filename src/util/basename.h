...
#ifndef GDS_BASENAME_H
#define GDS_BASENAME_H
 ...
 */
char *gds_basename(const char* filename) __gds_attribute_malloc__ __gds_attribute_warn_unused_result__;
 ...
 * The caller is responsible for freeing the returned string.
 */
char *gds_dirname(const char* filename) __gds_attribute_malloc__ __gds_attribute_warn_unused_result__;

END_C_DECLS

#endif /* GDS_BASENAME_H */
