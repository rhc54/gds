...
BEGIN_C_DECLS
   ...
   */
gds_status_t gds_argv_append(int *argc, char ***argv, const char *arg) __gds_attribute_nonnull__(1) __gds_attribute_nonnull__(3);
   ...
   * @retval GDS_ERROR On failure
   *
   * This function is identical to the gds_argv_append() function
 ...
 * @retval GDS_ERROR On failure
 *
 * This function is identical to the gds_argv_append_nosize() function
...
void gds_argv_free(char **argv);
   ...
   */
char **gds_argv_split(const char *src_string, int delimiter) __gds_attribute_malloc__ __gds_attribute_warn_unused_result__;
   ...
   * without invalidating the output argv).
   */
char **gds_argv_split_with_empty(const char *src_string, int delimiter) __gds_attribute_malloc__ __gds_attribute_warn_unused_result__;
...
int gds_argv_count(char **argv);
   ...
   */
char *gds_argv_join(char **argv, int delimiter) __gds_attribute_malloc__ __gds_attribute_warn_unused_result__;

char *gds_argv_join_range(char **argv, size_t start, size_t end, int delimiter) __gds_attribute_malloc__ __gds_attribute_warn_unused_result__;
...
size_t gds_argv_len(char **argv);
   ...
   */
char **gds_argv_copy(char **argv) __gds_attribute_malloc__ __gds_attribute_warn_unused_result__;
     ...
     */
gds_status_t gds_argv_delete(int *argc, char ***argv,
     ...
     * @retval GDS_BAD_PARAM if any parameters are non-sensical
     *
     ...
     * Similar to gds_argv_append(), the target may be realloc()'ed
