 ...
 *
 * The gds_os_path() function takes a variable number of string arguments and
...
#ifndef GDS_OS_PATH_H
#define GDS_OS_PATH_H
...
*/
char *gds_os_path(bool relative, ...) __gds_attribute_malloc__ __gds_attribute_sentinel__ __gds_attribute_warn_unused_result__;

/**
 * Convert the path to be OS friendly. On UNIX this function will
 * be empty.
 */
#define gds_make_filename_os_friendly(PATH)   (PATH)
