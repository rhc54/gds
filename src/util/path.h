 ...
 */
char *gds_path_find(char *fname, char **pathv, int mode,
                                   char **envv) __gds_attribute_malloc__ __gds_attribute_warn_unused_result__;
 ...
 * The caller is responsible for freeing the returned string.
 */
char *gds_path_findv(char *fname, int mode,
                                    char **envv, char *wrkdir) __gds_attribute_malloc__ __gds_attribute_warn_unused_result__;
/**
 ...
 * will be returned.
 */
char* gds_find_absolute_path( char* app_name ) __gds_attribute_warn_unused_result__;
 ...
 * The caller is responsible for freeing the returned string.
 */
char *gds_path_access(char *fname, char *path, int mode) __gds_attribute_malloc__ __gds_attribute_warn_unused_result__;
 ...
 * @retval false               otherwise
 */
bool gds_path_nfs(char *fname, char **fstype) __gds_attribute_warn_unused_result__;
 ...
 *
 * @retval GDS_SUCCESS  If the operation was successful
 * @retval GDS_ERROR    otherwise
 */
int
gds_path_df(const char *path,
             uint64_t *out_avail)__gds_attribute_warn_unused_result__;
