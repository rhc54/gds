...
#ifndef GDS_POINTER_ARRAY_H
#define GDS_POINTER_ARRAY_H
 ...
 * Convenience typedef
 */
typedef struct gds_pointer_array_t gds_pointer_array_t;
/**
 * Class declaration
 */
GDS_CLASS_DECLARATION(gds_pointer_array_t);
 ...
 *
 * @return GDS_SUCCESS if all initializations were succesfull. Otherwise,
 ...
 */
int gds_pointer_array_add(gds_pointer_array_t *array, void *ptr);
 ...
 *
 * @return GDS_SUCCESS if item was inserted. Otherwise,
 *  the error indicate what went wrong in the function.
 */
gds_status_t gds_pointer_array_set_item(gds_pointer_array_t *array,
...
static inline void *gds_pointer_array_get_item(gds_pointer_array_t *table,
                                                int element_index)
{
    void *p;
 ...
 */
static inline int gds_pointer_array_get_size(gds_pointer_array_t *array)
{
  return array->size;
}
 ...
 *
 * @return GDS_SUCCESS new size was set. Otherwise,
 *  the error indicate what went wrong in the function.
 *
 * Simple function to set the size of the array in order to
 * hide the member field from external users.
 */
gds_status_t gds_pointer_array_set_size(gds_pointer_array_t *array, int size);
 ...
 *
 */
static inline void gds_pointer_array_remove_all(gds_pointer_array_t *array)
{
    int i;
