...
#ifndef GDS_RING_BUFFER_H
#define GDS_RING_BUFFER_H
 ...
 * Convenience typedef
 */
typedef struct gds_ring_buffer_t gds_ring_buffer_t;
/**
 * Class declaration
 */
GDS_CLASS_DECLARATION(gds_ring_buffer_t);
