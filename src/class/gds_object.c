 ...
 * @file
 *
 * Implementation of gds_object_t, the base gds foundation class
 */
 ...
 */
gds_class_t gds_object_t_class = {
    "gds_object_t",      /* name */
    NULL,                 /* parent class */
    NULL,                 /* constructor */
    NULL,                 /* destructor */
    ...
    sizeof(gds_object_t) /* size of the gds object */
};
 ...
 * Local functions
 */
static void save_class(gds_class_t *cls);
 ...
 */
void gds_class_initialize(gds_class_t *cls)
{
    gds_class_t *c;
    ...
    cls->cls_construct_array =
        (void (**)(gds_object_t*))malloc((cls_construct_array_count +
                                           cls_destruct_array_count + 2) *
                                          sizeof(gds_construct_t) );
