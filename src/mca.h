 ...
 * @file
 *
 * Top-level interface for all gds MCA components.
 */
 ...
 * name and version.
 */
struct gds_mca_base_module_2_0_0_t {
    int dummy_value;
};
/** Unversioned convenience typedef; use this name in
    frameworks/components to stay forward source-compatible */
typedef struct gds_mca_base_module_2_0_0_t gds_mca_base_module_t;
/** Versioned convenience typedef */
typedef struct gds_mca_base_module_2_0_0_t gds_mca_base_module_2_0_0_t;


/**
 * MCA component open function.
 *
 * @retval GDS_SUCCESS This component can be used in the process.
 *
 * @retval GDS_ERR_NOT_AVAILABLE Silently ignore this component for
 ...
 *
 * This function should return GDS_SUCCESS if it wishes to remain
 ...
 * function and it returned GDS_SUCCESS.
 */
typedef int (*gds_mca_base_open_component_1_0_0_fn_t)(void);

/**
 * MCA component close function.
 *
 * @retval GDS_SUCCESS The component successfully shut down.
 *
 ...
 * close function and it returned GDS_SUCCESS.
 */
typedef int (*gds_mca_base_close_component_1_0_0_fn_t)(void);

/**
 * MCA component query function.
 *
 * @retval GDS_SUCCESS The component successfully queried.
 *
 * @retval any_other_value Some error occurred, but is likely to be
 * ignored.
 *
 ...
 */
typedef int (*gds_mca_base_query_component_2_0_0_fn_t)(gds_mca_base_module_2_0_0_t **module, int *priority);

/**
 * MCA component parameter registration function.
 *
 * @retval GDS_SUCCESS This component successfully registered its
 * parameters and can be used in this process.
 * @retval GDS_ERR_BAD_PARAM Indicates that the register function
 ...
 * mechanism is available should the need arise.
 *
 * Note that if the function returns GDS_ERR_BAD_PARAM, it is
 ...
 * registration function and it returned GDS_SUCCESS.
 */
typedef int (*gds_mca_base_register_component_params_2_0_0_fn_t)(void);


/**
 * Maximum length of MCA project string names.
 */
#define GDS_MCA_BASE_MAX_PROJECT_NAME_LEN 15
/**
 * Maximum length of MCA framework string names.
 */
#define GDS_MCA_BASE_MAX_TYPE_NAME_LEN 31
/**
 * Maximum length of MCA component string names.
 */
#define GDS_MCA_BASE_MAX_COMPONENT_NAME_LEN 63
 ...
 * name and version.
 */
struct gds_mca_base_component_2_1_0_t {

  int gds_mca_major_version;
  /**< Major number of the MCA. */
  int gds_mca_minor_version;
  /**< Minor number of the MCA. */
  int gds_mca_release_version;
  /**< Release number of the MCA. */

  char gds_mca_project_name[GDS_MCA_BASE_MAX_PROJECT_NAME_LEN + 1];
  /**< String name of the project that this component belongs to. */
  int gds_mca_project_major_version;
  /**< Major version number of the project that this component
     belongs to. */
  int gds_mca_project_minor_version;
  /**< Minor version number of the project that this component
     belongs to. */
  int gds_mca_project_release_version;
  /**< Release version number of the project that this component
     belongs to. */

  char gds_mca_type_name[GDS_MCA_BASE_MAX_TYPE_NAME_LEN + 1];
  /**< String name of the framework that this component belongs to. */
  int gds_mca_type_major_version;
  /**< Major version number of the framework that this component
     belongs to. */
  int gds_mca_type_minor_version;
  /**< Minor version number of the framework that this component
     belongs to. */
  int gds_mca_type_release_version;
  /**< Release version number of the framework that this component
     belongs to. */

  char gds_mca_component_name[GDS_MCA_BASE_MAX_COMPONENT_NAME_LEN + 1];
  /**< This comopnent's string name. */
  int gds_mca_component_major_version;
  /**< This component's major version number. */
  int gds_mca_component_minor_version;
  /**< This component's minor version number. */
  int gds_mca_component_release_version;
  /**< This component's release version number. */

  gds_mca_base_open_component_1_0_0_fn_t gds_mca_open_component;
  /**< Method for opening this component. */
  gds_mca_base_close_component_1_0_0_fn_t gds_mca_close_component;
  /**< Method for closing this component. */
  gds_mca_base_query_component_2_0_0_fn_t gds_mca_query_component;
  /**< Method for querying this component. */
  gds_mca_base_register_component_params_2_0_0_fn_t gds_mca_register_component_params;
...
/** Unversioned convenience typedef; use this name in
    frameworks/components to stay forward source-compatible */
typedef struct gds_mca_base_component_2_1_0_t gds_mca_base_component_t;
/** Versioned convenience typedef */
typedef struct gds_mca_base_component_2_1_0_t gds_mca_base_component_2_1_0_t;

/*
 * Metadata Bit field parameters
 */
#define GDS_MCA_BASE_METADATA_PARAM_NONE        (uint32_t)0x00 /**< No Metadata flags */
#define GDS_MCA_BASE_METADATA_PARAM_CHECKPOINT  (uint32_t)0x02 /**< Checkpoint enabled Component */
#define GDS_MCA_BASE_METADATA_PARAM_DEBUG       (uint32_t)0x04 /**< Debug enabled/only Component */

/**
 * Meta data for MCA v2.0.0 components.
 */
struct gds_mca_base_component_data_2_0_0_t {
...
/** Unversioned convenience typedef; use this name in
    frameworks/components to stay forward source-compatible */
typedef struct gds_mca_base_component_data_2_0_0_t gds_mca_base_component_data_t;
/** Versioned convenience typedef */
typedef struct gds_mca_base_component_data_2_0_0_t gds_mca_base_component_data_2_0_0_t;
 ...
 */
#define GDS_MCA_BASE_VERSION_MAJOR 2
#define GDS_MCA_BASE_VERSION_MINOR 1
#define GDS_MCA_BASE_VERSION_RELEASE 0

#define GDS_MCA_BASE_MAKE_VERSION(level, MAJOR, MINOR, RELEASE) \
    .gds_mca_## level ##_major_version = MAJOR,                 \
    .gds_mca_## level ##_minor_version = MINOR,                 \
    .gds_mca_## level ##_release_version = RELEASE


#define GDS_MCA_BASE_VERSION_2_1_0(PROJECT, project_major, project_minor, project_release, TYPE, type_major, type_minor, type_release) \
    .gds_mca_major_version = GDS_MCA_BASE_VERSION_MAJOR,                        \
    .gds_mca_minor_version = GDS_MCA_BASE_VERSION_MINOR,                        \
    .gds_mca_release_version = GDS_MCA_BASE_VERSION_RELEASE,                    \
    .gds_mca_project_name = PROJECT,                                        \
    GDS_MCA_BASE_MAKE_VERSION(project, project_major, project_minor, project_release), \
    .gds_mca_type_name = TYPE,                                              \
    GDS_MCA_BASE_MAKE_VERSION(type, type_major, type_minor, type_release)


#define GDS_MCA_BASE_VERSION_1_0_0(type, type_major, type_minor, type_release) \
    GDS_MCA_BASE_VERSION_2_1_0("gds", GDS_MAJOR_VERSION, GDS_MINOR_VERSION,      \
                                GDS_RELEASE_VERSION, type, type_major, type_minor, \
                                type_release)
