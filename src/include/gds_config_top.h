 ...
 * $HEADER$
 *
 * This file is included at the top of gds_config.h, and is
 * therefore a) before all the #define's that were output from
 * configure, and b) included in most/all files in GDS.
 *
 * Since this file is *only* ever included by gds_config.h, and
 * gds_config.h already has #ifndef/#endif protection, there is no
 * need to #ifndef/#endif protection here.
 */

#ifndef GDS_CONFIG_H
#error "gds_config_top.h should only be included from config.h(.in)"
#endif
