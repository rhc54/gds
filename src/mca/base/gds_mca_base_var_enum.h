...
#if !defined(GDS_MCA_BASE_VAR_ENUM_H)
#define GDS_MCA_BASE_VAR_ENUM_H
...
typedef struct gds_mca_base_var_enum_t gds_mca_base_var_enum_t;
 ...
 */
typedef int (*gds_mca_base_var_enum_get_count_fn_t)(gds_mca_base_var_enum_t *self, int *count);
 ...
 */
typedef int (*gds_mca_base_var_enum_get_value_fn_t)(gds_mca_base_var_enum_t *self, int index,
 ...
 *
 * @retval GDS_SUCCESS if found
 * @retval GDS_ERR_VALUE_OUT_OF_BOUNDS if not
 */
typedef int (*gds_mca_base_var_enum_vfs_fn_t)(gds_mca_base_var_enum_t *self, const char *string_value,
                                               int *value);
 ...
 * @retval gds error on error
 */
typedef int (*gds_mca_base_var_enum_dump_fn_t)(gds_mca_base_var_enum_t *self, char **out);
 ...
 *
 * @retval GDS_SUCCESS on success
 * @retval GDS_ERR_VALUE_OUT_OF_BOUNDS if not found
 *
 ...
 */
typedef int (*gds_mca_base_var_enum_sfv_fn_t)(gds_mca_base_var_enum_t *self, const int value,
                                               char **string_value);
 ...
 */
struct gds_mca_base_var_enum_value_t {
    int value;
    const char *string;
};

typedef struct gds_mca_base_var_enum_value_t gds_mca_base_var_enum_value_t;

/**
 * enumerator base class
 */
struct gds_mca_base_var_enum_t {
    gds_object_t super;
    ...
    gds_mca_base_var_enum_value_t *enum_values;
};
 ...
 */
struct gds_mca_base_var_enum_value_flag_t {
...
typedef struct gds_mca_base_var_enum_value_flag_t gds_mca_base_var_enum_value_flag_t;

/**
 * flag enumerator base class
 */
struct gds_mca_base_var_enum_flag_t {
    /** use the existing enumerator interface */
    gds_mca_base_var_enum_t super;
    /** flag value(s) */
    gds_mca_base_var_enum_value_flag_t *enum_flags;
};

typedef struct gds_mca_base_var_enum_flag_t gds_mca_base_var_enum_flag_t;

/**
 * Object declaration for gds_mca_base_var_enum_t
 */
GDS_CLASS_DECLARATION(gds_mca_base_var_enum_t);
 ...
 *
 * @retval GDS_SUCCESS On success
 * @retval gds error code On error
 *
 ...
 * strings passed in values[] after gds_mca_base_var_enum_create()
 * returns.
 */
int gds_mca_base_var_enum_create (const char *name, const gds_mca_base_var_enum_value_t values[],
                                   gds_mca_base_var_enum_t **enumerator);
 ...
 * returns.
 */
int gds_mca_base_var_enum_create_flag (const char *name, const gds_mca_base_var_enum_value_flag_t flags[],
                                        gds_mca_base_var_enum_flag_t **enumerator);
 ...
 */
extern gds_mca_base_var_enum_t gds_mca_base_var_enum_bool;

/**
 * Verbosity level enumerator
 */
extern gds_mca_base_var_enum_t gds_mca_base_var_enum_verbose;
